...
bool latency_interfaces__msg__latency_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("latency_interfaces.msg._latency_msg.LatencyMsg", full_classname_dest, 46) == 0);
  }
  latency_interfaces__msg__LatencyMsg * ros_message = _ros_message;
  {  // message_id
    ...
    ros_message->message_id = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of LatencyMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("latency_interfaces.msg._latency_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LatencyMsg");
  ...
  {  // message_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->message_id);
    {
